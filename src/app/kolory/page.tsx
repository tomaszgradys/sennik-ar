...
const title = `Znaczenie kolorów — symbolika barw i sny — ${SITE.name}`;
const description =
  "Co symbolizują kolory? Sprawdź znaczenie czerwonego, czarnego, białego i innych barw — w symbolice, emocjach i snach. Ciepło i po ludzku.";
    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-8">
      ...
      <header className="text-center">
        ...
        <p className="mx-auto mt-3 max-w-xl text-text-muted">
          Każdy kolor niesie własny nastrój i symbolikę. Sprawdź, co oznaczają
          barwy w emocjach, relacjach i snach — spokojnie, po ludzku.
        </p>
      </header>
