  ...
  return (
    ...
    >
      ...
      <p>
        ...
        والأرقام، وأطوار القمر، ومدوّنة. الخدمة متاحة أونلاين ومجانية في جوهرها.
        الموقع لا يتطلّب تسجيل الدخول ولا يجمع بيانات شخصية من زوّاره.
      </p>
      {LEGAL.operatorForm ? (
        <p>
      ...
      <p>
        ...
        والاطّلاع على طور القمر، وقراءة المدوّنة. جميع المحتويات متاحة للتصفّح بحرّية دون
        إنشاء حساب أو تسجيل دخول. قد تتغيّر الميزات أو المحتوى أو تُضاف إليها مع الوقت.
      </p>

      <h2>3. طبيعة المحتوى وإخلاء المسؤولية</h2>
      <p>
        تفسيرات الأحلام والألوان والأرقام ذات طابع <strong>معلوماتي وترفيهي وتأمّلي</strong>،
      ...
      <h2>7. الخصوصية وعدم جمع البيانات</h2>
      <p>
