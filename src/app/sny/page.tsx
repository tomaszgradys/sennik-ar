...
// محور «كل الفئات» تحت /sny/ — فهرس مركزي يربط المحاور الاثني عشر.
// يُصلح روابط داخلية كانت تشير إلى 404، ويقصّر عمق الزحف (الرئيسية → /sny/ → المحور → الرمز).
export const revalidate = 86400;

const url = `${SITE.url}/sny/`;
