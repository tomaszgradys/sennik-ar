...
// الجاذب: الدافع الحقيقي للبحث هو اسم بعينه ظهر في الحلم.
// العلامة التجارية خارج <title>: جوجل يعرض اسم الموقع منفصلاً في نتائج الهاتف.
const title = "تفسير الأسماء في المنام: من ظهر لك في حلمك؟";
const description =
