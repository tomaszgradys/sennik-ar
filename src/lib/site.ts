...
export const SITE = {
  ...
  lang: "ar",
  dir: "rtl" as const,
  // تواريخ صادقة للمحتوى (إشارات E-E-A-T في Article schema، مطابقة لما يعرضه المنافسون).
  // النسخة العربية أُطلقت 2026-07-08 وخضعت لمراجعة تحريرية 2026-07-09.
  contentPublished: "2026-07-08",
